## はじめに
### 1.実験関連フォルダのダウンロード
https://drive.google.com/drive/my-drive/ から実験に必要な以下のフォルダをダウンロードしてください．  

**AGDRec_132F**：画面録画ソフトのフォルダ  
**GitCollabSim**：実験用フォルダ  

### 2.画面録画設定
**AGDRec_132F**内の**AGDRec64.exe**を起動してください．  
[設定内容]  
コーデック：**Windows Media Video**  
エンコードモード：**リアルタイムエンコード**  

設定が完了すると画面下部のタスクバーに緑色の[**AG**]が出てくるので，これを右クリックしてください．  
表示されていない場合は[**∧**]をクリックして隠れたインジケーターを確認してください．  
[**全画面録画**]にチェックが入ってることを確認し，録画開始を選択して[**AG**]が赤色になることを確認してください．  
